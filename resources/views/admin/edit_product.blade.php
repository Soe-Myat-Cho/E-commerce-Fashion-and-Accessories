        ...
        <div class=" sm:mx-auto sm:w-full sm:max-w-sm pb-10">
            <form class="space-y-6" action="" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="file" name="image" id="image" class="border block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-gray-700 sm:text-sm/6">
                    </div>
                </div>
